...
```
Create a drawbridge managed ssh config & associated files

Current Answers:
stack_name: app
Please enter a value for `environment` [string] - What is the environment name?:
test
Please enter a value for `shard` [string] - What is the shard datacenter?:
us-east-1
...
aws
WARNING: PEM file missing. Place it at the following location before attempting to connect. /Users/jason/.ssh/drawbridge/pem/test/aws-test.pem
