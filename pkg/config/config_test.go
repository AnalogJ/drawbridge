...
func TestConfiguration_init_ShouldCorrectlyInitializeConfiguration(t *testing.T) {
	...
	require.Equal(t, []string{"pem", "config"}, testConfig.GetStringSlice("options.active_templates"), "should populate active template with default")
}
...
func TestConfiguration_ReadConfig_Simple(t *testing.T) {
	...
	require.Equal(t, "~/.ssh/drawbridge", testConfig.GetString("options.config_dir"), "should populate config_dir with default")
	require.Equal(t, []string{"default","knife"}, testConfig.GetStringSlice("options.active_templates"), "should populate active_templates with overrides")
